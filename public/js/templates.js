...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "</b></a>\n    </div>\n    <div class=\"navbar-collapse collapse\">\n      <ul class=\"nav navbar-nav\">\n        <li class=\"active\"><a href=\"#sampleReport\">Sample Report</a></li>\n      </ul>\n    </div><!--/.nav-collapse -->\n  </div>\n</div>\n\n<div class=\"container\">\n  <div class=\"row centered\">\n\n    <div id='fishingAppContent'></div>\n\n  </div>\n</div>\n\n\n<div class='navbar navbar-fixed-bottom'>\n  <div class='footer'>\n    <div class=\"container\">\n      <p>";
  if (stack1 = helpers.appName) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = (depth0 && depth0.appName); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
    + "</p>\n    </div>\n  </div>\n</div>";
...
this["Fishing"]["Template"]["bb/template/sampleReport.html"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  


  return "<div>\n  <img src='img/1_scores.png' />\n</div>\n\n<div>\n  <img src='img/2_graphs.png' />\n</div>\n\n<div>\n  <img src='img/3_weather.png' />\n</div>\n\n<div>\n  <img src='img/4_fish.png' />\n</div>\n\n<div>\n  <img src='img/5_area.png' />\n</div>";
  });